...
#     print('\r\nMagnetic:      X = %d , Y = %d , Z = %d'%((Mag[0]),Mag[1],Mag[2]))
    ...
    print("Roll",f'{roll:.2f}',
          "Pitch",f'{pitch:.2f}',
          "Yaw",f'{yaw/10:.2f}',
          "Acc X",f'{Accel[0]//10000:d}',
          "Acc Y",f'{Accel[1]//10000:d}',
          "Acc Z",f'{Accel[2]//10000:d}',
          "Gyro X",f'{Gyro[0]//100:d}',
          "Gyro Y",f'{Gyro[1]//100:d}',
          "Gyro Z",f'{Gyro[2]//100:d}',
          "Mag X",f'{Mag[0]:.2f}',
          "Mag Y",f'{Mag[1]:.2f}',
          "Mag Z",f'{Mag[2]/10:.2f}'
          )
